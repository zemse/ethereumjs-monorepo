...
* @returns {any}
*/
module.exports.js_verify_update = function(js_root, js_proof, js_key_values) {
    try {
        var ret = wasm.js_verify_update(addHeapObject(js_root), addHeapObject(js_proof), addBorrowedObject(js_key_values));
...
module.exports.__wbg_from_3a079295289ec0d1 = function(arg0) {
    var ret = Array.from(getObject(arg0));
    return addHeapObject(ret);
};

module.exports.__wbg_entries_743188235dafee49 = function(arg0) {
